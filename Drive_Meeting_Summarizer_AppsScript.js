...
function doGet(e) {
  ...
  var html = '<!DOCTYPE html>' +
    ...
    '  <link rel="icon" type="image/jpeg" href="' + APP_ICON_BASE64 + '">' +
    '  <link rel="apple-touch-icon" href="' + APP_ICON_BASE64 + '">' +
